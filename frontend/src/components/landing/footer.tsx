...
import { Sparkles, Twitter, Instagram, Linkedin, Youtube, Github, Mail, MapPin, Phone } from "lucide-react"
  ...
  return (
    <footer className="relative border-t border-border/30 bg-card/30">
      <div className="container px-4 md:px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-xs">
              Transforming education through interactive learning, AI guidance, and real-world projects.
            </p>
        ...
        {/* Bottom section */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mt-16 pt-8 border-t border-border/30">
