...
//     color: "from-nazli-purple to-nazli-purple/70",
...
//     color: "from-nazli-purple/80 to-nazli-purple",
//     glowColor: "rgba(139, 92, 246, 0.3)",
//   },
//   {
//     id: "usa",
...
//       "Tech Internships",
//     ],
//     color: "from-nazli-golden to-nazli-golden/70",
...
//     ],
//     color: "from-nazli-golden/80 to-nazli-golden",
//     glowColor: "rgba(245, 158, 11, 0.3)",
//   },
// ];
...
//         >
//           <motion.div
//             className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-nazli-purple/30 bg-nazli-purple/5 mb-6"
...
//             >
//               <Globe className="w-4 h-4 text-nazli-purple" />
//             </motion.div>
//             <span className="text-sm text-nazli-purple font-medium">
//               Global Presence
//             </span>
//           </motion.div>
...
//                       color: "text-nazli-white",
//                     },
//                     {
//                       icon: GraduationCap,
//                       value: activeRegion.graduates,
//                       label: "Graduates",
//                       color: "text-nazli-golden",
//                     },
//                     {
//                       icon: Building2,
//                       value: activeRegion.partners,
//                       label: "Partners",
//                       color: "text-nazli-purple",
//                     },
//                   ].map((stat, i) => (
//                     <motion.div
//                       key={stat.label}
