...
import { Globe, Users, GraduationCap, Building2, MapPin, Sparkles } from "lucide-react"
...
const regions = [
  {
    ...
    graduates: "890",
    partners: "15",
    description: "Leading tech education hub in West Africa with state-of-the-art facilities in Lagos and Abuja.",
  ...
  },
  {
    ...
    graduates: "650",
    partners: "22",
    description: "Strategic partnership with top UK universities and tech companies in London and Manchester.",
  ...
  },
  {
    ...
    graduates: "1,100",
    partners: "35",
    description: "Silicon Valley connections and partnerships with leading tech giants and startups.",
    highlights: ["Silicon Valley Tours", "Startup Incubator", "Tech Internships"],
  ...
  },
  {
    ...
    graduates: "420",
    partners: "18",
    description: "Growing presence in Toronto and Vancouver with focus on AI and clean tech.",
    highlights: ["AI Ethics Program", "Clean Tech Focus", "Immigration Pathways"],
      ...
      <div className="container relative z-10 px-4 md:px-6">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-glow-cyan font-medium">Global Presence</span>
          </motion.div>
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Join a global community of learners and innovators from around the world
          </p>
        </motion.div>
          ...
          >
            {regions.map((region, index) => (
              <motion.button
                ...
                style={{
                  boxShadow: activeRegion.id === region.id ? `0 0 30px ${region.glowColor}` : 'none'
                }}
                whileHover={{ x: 5 }}
              >
                <div className="flex items-center gap-4">
                  <motion.div 
                    ...
                    animate={hoveredRegion === region.id ? { rotate: [0, -5, 5, 0] } : {}}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-muted-foreground">{region.students} students</div>
                  </div>
                  {activeRegion.id === region.id && (
                    <motion.div
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-foreground">{activeRegion.name}</h3>
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                  {[
                    { icon: Users, value: activeRegion.students, label: "Active Students", color: "text-primary" },
                    { icon: GraduationCap, value: activeRegion.graduates, label: "Graduates", color: "text-accent" },
                    { icon: Building2, value: activeRegion.partners, label: "Partners", color: "text-glow-cyan" },
                  ].map((stat, i) => (
                    <motion.div 
                      key={stat.label}
