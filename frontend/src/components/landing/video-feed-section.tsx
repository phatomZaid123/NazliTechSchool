...
export function VideoFeedSection() {
  ...
  const headingText = "Are Building";
      ...
      <div className="container relative z-10 px-4 md:px-6">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
            <button
              className="absolute -left-4 top-1/2 -translate-y-1/2 z-10 rounded-full bg-background/80 backdrop-blur-sm border border-border/50 hidden md:flex hover:border-primary/50 hover:bg-primary/10 w-10 h-10 items-center justify-center"
              onClick={() => scroll("left")}
            >
          ...
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
            <button
              className="absolute -right-4 top-1/2 -translate-y-1/2 z-10 rounded-full bg-background/80 backdrop-blur-sm border border-border/50 hidden md:flex hover:border-primary/50 hover:bg-primary/10 w-10 h-10 items-center justify-center"
...
function VideoCard({
  ...
  return (
    <motion.div
      onClick={onClick}
      className={`relative w-65 aspect-9/16 rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 ${
